/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.control.jsonc --env-interface=CloudflareControlEnv src/generated/control-env.d.ts` (hash: 85000dd87a837864b610e045d39a0413)
// Runtime types generated with workerd@1.20260831.1 2026-09-04 nodejs_compat
interface __BaseEnv_CloudflareControlEnv {
	DB: D1Database;
	...
	INSTANCE_PEPPER: string;
	ENCRYPTION_KEY: string;
	AUDIT_SIGNING_KEY: string;
	AUTH: DurableObjectNamespace<import("../control").AuthDurableObject>;
	QUOTA: DurableObjectNamespace<import("../control").QuotaDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../control");
		durableNamespaces: "AuthDurableObject" | "QuotaDurableObject";
	}
	interface Env extends __BaseEnv_CloudflareControlEnv {}
}
interface CloudflareControlEnv extends __BaseEnv_CloudflareControlEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADAPTER_NAME" | "ADAPTER_VERSION" | "ADMIN_ALLOWED_ORIGINS" | "DEFAULT_ACCESS_TTL_SECONDS" | "DEFAULT_REFRESH_TTL_SECONDS" | "REPORT_TTL_SECONDS" | "BOOTSTRAP_SECRET" | "INSTANCE_PEPPER" | "ENCRYPTION_KEY" | "AUDIT_SIGNING_KEY">> {}
}
